...
DEVICE_PACKAGE_OVERLAYS += $(call project-path-for,qcom-audio)/configs/common_au/overlay

ifneq ( ,$(filter U UpsideDownCake 14, $(PLATFORM_VERSION)))
PRODUCT_COPY_FILES += \
    $(TOPDIR)$(call project-path-for,qcom-audio)/configs/msmnile_au/audio_effects_64.conf:$(TARGET_COPY_OUT_VENDOR)/etc/audio_effects.conf
else
PRODUCT_COPY_FILES += \
    $((TOPDIR)$(call project-path-for,qcom-audio)/configs/msmnile_au/audio_effects.conf:$(TARGET_COPY_OUT_VENDOR)/etc/audio_effects.conf
endif

PRODUCT_COPY_FILES += \
    $(call project-path-for,qcom-audio)/configs/msmnile_au/mixer_paths_adp.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_adp.xml \
    $(call project-path-for,qcom-audio)/configs/msmnile_au/audio_io_policy.conf:$(TARGET_COPY_OUT_VENDOR)/etc/audio_io_policy.conf \
    $(call project-path-for,qcom-audio)/configs/msmnile_au/audio_effects.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_effects.xml \
    $(call project-path-for,qcom-audio)/configs/msmnile_au/mixer_paths_sa8295_adp.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_sa8295_adp.xml \
    $(call project-path-for,qcom-audio)/configs/msmnile_au/audio_tuning_mixer.txt:$(TARGET_COPY_OUT_VENDOR)/etc/audio_tuning_mixer.txt \
    $(call project-path-for,qcom-audio)/configs/msmnile_au/sound_trigger_platform_info.xml:$(TARGET_COPY_OUT_VENDOR)/etc/sound_trigger_platform_info.xml \
    $(call project-path-for,qcom-audio)/configs/msmnile_au/graphite_ipc_platform_info.xml:$(TARGET_COPY_OUT_VENDOR)/etc/graphite_ipc_platform_info.xml \
    $(call project-path-for,qcom-audio)/configs/msmnile_au/audio_platform_info.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info.xml \
    $(call project-path-for,qcom-audio)/configs/msmnile_au/audio_platform_info_qrd.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info_qrd.xml \
    $(call project-path-for,qcom-audio)/configs/msmnile_au/audio_platform_info_sa8295.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info_sa8295.xml \
    $(call project-path-for,qcom-audio)/configs/msmnile_au/mixer_paths_custom.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_custom.xml \
    $(call project-path-for,qcom-audio)/configs/msmnile_au/sound_trigger_mixer_paths.xml:$(TARGET_COPY_OUT_VENDOR)/etc/sound_trigger_mixer_paths.xml \
    $(call project-path-for,qcom-audio)/configs/msmnile_au/audio_configs.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_configs.xml \
    $(call project-path-for,qcom-audio)/configs/msmnile_au/audio_configs_stock.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_configs_stock.xml \
...
PRODUCT_COPY_FILES += \
    $(TOPDIR)$(call project-path-for,qcom-audio)/configs/msmnile_au/card-defs-dummy.xml:$(TARGET_COPY_OUT_VENDOR)/etc/card-defs-dummy.xml

#XML Audio configuration files
ifneq ($(TARGET_USES_AOSP_FOR_AUDIO), true)
ifneq ( ,$(filter U UpsideDownCake 14, $(PLATFORM_VERSION)))
PRODUCT_COPY_FILES += \
    $(TOPDIR)$(call project-path-for,qcom-audio)/configs/msmnile_au/audio_policy_configuration_7_0.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio/audio_policy_configuration.xml
else
PRODUCT_COPY_FILES += \
    $(TOPDIR)$(call project-path-for,qcom-audio)/configs/msmnile_au/audio_policy_configuration.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio/audio_policy_configuration.xml
endif
endif

ifneq ( ,$(filter U UpsideDownCake 14, $(PLATFORM_VERSION)))
PRODUCT_COPY_FILES += \
    $(TOPDIR)$(call project-path-for,qcom-audio)/configs/common_au/audio_policy_configuration_7_0.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_configuration.xml \
...
PRODUCT_COPY_FILES += \
    $(TOPDIR)$(call project-path-for,qcom-audio)/configs/common_au/audio_policy_configuration.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_configuration.xml \
...
PRODUCT_COPY_FILES += \
    ...
    $(TOPDIR)$(call project-path-for,qcom-audio)/configs/common_au/car_audio_configuration.xml:$(TARGET_COPY_OUT_VENDOR)/etc/car_audio_configuration.xml

# Listen configuration file
PRODUCT_COPY_FILES += \
    $(call project-path-for,qcom-audio)/configs/msmnile_au/listen_platform_info.xml:$(TARGET_COPY_OUT_VENDOR)/etc/listen_platform_info.xml
